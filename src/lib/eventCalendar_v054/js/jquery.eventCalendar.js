...
;$.fn.eventCalendar = function(options){
	...
	console.log("eventOpts = ", eventsOpts);
	...
	function dateSlider(show, year, month) {
		...
		// bk, 정렬 수정.
		$eventsCalendarTitle.find('.monthTitle').html(year + '년 ' + eventsOpts.monthNames[month]);
		...
		$eventsCalendarSlider.css('height',$eventsCalendarMonthWrap.height() + 29 +'px');
	}
/*
